...
import pickle
import torch
from utils import Encoder, Decoder, Seq2SeqTransformer, initialize_weights, text_transform, my_tokenizer
...
text_transform = text_transform(token_transform, vocab_transform)
...
def translate():
    ...
    print("trg token length: ", len(trg_tokens))
    print("src token length: ", len(src_text))
